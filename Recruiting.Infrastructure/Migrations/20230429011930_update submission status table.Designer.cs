...
namespace Recruiting.Infrastructure.Migrations
{
    ...
    [Migration("20230429011930_update submission status table")]
    partial class updatesubmissionstatustable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recruiting.Core.Entity.Candidate", b =>
                {
            ...
            modelBuilder.Entity("Recruiting.Core.Entity.JobRequirement", b =>
                {
            ...
            modelBuilder.Entity("Recruiting.Core.Entity.Submission", b =>
                {
            ...
            modelBuilder.Entity("Recruiting.Core.Entity.SubmissionStatus", b =>
                {
            ...
            modelBuilder.Entity("Recruiting.Core.Entity.Submission", b =>
                {
                    b.HasOne("Recruiting.Core.Entity.Candidate", "Candidate")
                        .WithMany("Submissions")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Recruiting.Core.Entity.JobRequirement", "JobRequirement")
                        .WithMany("Submissions")
                        .HasForeignKey("JobRequirementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Recruiting.Core.Entity.SubmissionStatus", "SubmissionStatus")
                        .WithMany("Submissions")
