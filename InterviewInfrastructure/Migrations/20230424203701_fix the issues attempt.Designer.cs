...
namespace InterviewInfrastructure.Migrations
{
    ...
    [Migration("20230424203701_fix the issues attempt")]
    partial class fixtheissuesattempt
    {
            ...
            modelBuilder.Entity("InterviewCore.Entity.Interview", b =>
                {
                    ...
                    b.Property<int>("InterviewTypeCode1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InterviewCore.Entity.Interview", b =>
                {
                    ...
                    b.HasOne("InterviewCore.Entity.InterviewType", "InterviewType")
                        .WithMany("Interview")
                        .HasForeignKey("InterviewTypeCode1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
